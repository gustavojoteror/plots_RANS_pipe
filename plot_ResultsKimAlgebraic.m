...
turbMod       = {'SST_Sta','MK_Mod','SA_Sta'};           % = {'VF','SST','MK','SA'};
turbModname   = {'SST','MK-$\rho$','SA'};           % = {'V2F','SST','MK','SA'};%'$\overline{v^2}-f$'};
fluid         = {'30','23'};
fluidname     = {'$30~kW/m^2$','$23~kW/m^2$'};   
tempMod       = {'Prt0_9','Kays','Irrenfried'};
tempMod_name  = {'$Pr_t=0.9$','Kays','Irrefried'};
...
for k=1:nturb
    ...
    for i=1:nfluid
        ...
        for j=1:ntemp    
            ...
            filename2 = sprintf('data/case2/Q_%s/%s/%s/',fluid{i},tempMod{j},turbMod{k});
        ...
        if((putlegend==1) & (i==1))
            ...
            legend([h0 hh(1) hh(2) hh(3) ],{'Exp. Data',tempMod_name{1}, tempMod_name{2}, tempMod_name{3}},'location', locationlegend,'fontsize',fontsize*0.85);
    ...
    filename3 = sprintf('RANS_Kimdata_Algebraic_%s.eps',turbMod{k});
